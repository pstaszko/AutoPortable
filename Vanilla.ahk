...
HardRestartMatrixOS(){
	if(ComputerHasMatrixBoards()){
		...
		PSKill("matrixos")
		RunWait powershell -noprofile C:\dev\PowerShell\removeGhosts.ps1
		msgbox Have Matrix Boards been power cycled?
...
LoadGroups(){
	...
	g_1_ProgramGroups_End("AllowScrollLock","ahk_class Emacs")
	...
	g_2_AutomaticBehaviors("ActivateIfExist","VPN Connection Failure ahk_class #32770 ahk_exe FortiTray.exe", "VPN connection failed.")
